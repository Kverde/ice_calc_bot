...
abs - модуль числа
sin, cos, tan - аргумент градусы
asin, acos, atan - возвращают результат в градусах
sinr, cosr, tanr - аргумент радианы
asinr, acosr, atanr - возвращают результат в радианах

log, log10 - логарифм по основанию 10
